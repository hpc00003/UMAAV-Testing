...
class DroneMission(Node):
    ...
    def vehicle_local_position_callback(self, vehicle_local_position):
        ...
        #self.get_logger().info(f'Received local position: {vehicle_local_position.z}')
    ...
    def timer_callback(self) -> None:
        ...
        if self.vehicle_local_position.z > self.z\
            ...
            self.get_logger().info(f'The local z position is {self.vehicle_local_position.z}')

        elif self.vehicle_local_position.z <= self.z:
            self.z = self.z - 5.0
            self.setpoint = self.setpoint + 1
            self.get_logger().info('increased set point')
